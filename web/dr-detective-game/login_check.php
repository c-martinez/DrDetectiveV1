			...
			if (strcmp($_POST['pass'], $_POST['pass2']) == 0) {
				...
				if ($row = mysqli_fetch_array($res)) {
					if ($row["COUNT(*)"] == 0) {				
						...
						/*$query = "INSERT INTO game_user (Name, Password, Score, Last_Par_ID, Worker_role, Task)
							VALUES ('$name', '$pass', 0, -1, 'annotate', 'relations')";
						mysqli_query($con, $query);
						$query = "INSERT INTO game_user (Name, Password, Score, Last_Par_ID, Worker_role, Task)
							VALUES ('$name', '$pass', 0, -1, 'validate', 'factors')";
						mysqli_query($con, $query);
						$query = "INSERT INTO game_user (Name, Password, Score, Last_Par_ID, Worker_role, Task)
							VALUES ('$name', '$pass', 0, -1, 'validate', 'relations')";
						mysqli_query($con, $query);*/
