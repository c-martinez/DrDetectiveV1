      ...
      <div class="navbar-inner">
        <div class="container">
          ...
          <div class="nav-collapse collapse">
            <ul class="nav">
              <li class="active"><a href="#" onclick="nextPatient('index')">Task</a></li>
            ...
            <div class="menudet pull-left">Domain: <span class="menufont"><?php echo $domains;?></span></div>
          </div><!--/.nav-collapse -->
        </div>
      </div>
   </div>
...
<div class="span12">
<h4> <br/><br/><br/>
<p>This text is an excerpt of a case report on <span class="important"><?php echo $diagnosis; ?></span>.</p>

<p>Follow these steps to annotate all the terms in the text:</p>
</h4>
</div>
</div>
...
<div class="span3">
<h5>
<b>Step 1:</b> Select the type of term you are looking for.
</h5>
</div>
...
/*if (strcmp($fac_or_rel, "factors") == 0) {
	if (strcmp($worker_role, "annotate") == 0) {
		...
		echo "other players have found";
	}
	echo " all the clues ".$relation_roles[$rel_role].".";
}
else {
	if (strcmp($worker_role, "annotate") == 0) {
		echo "pick";
...
<?php 
//if (strcmp($fac_or_rel, "factors") == 0) echo  "1. Pick the type of clues to look for: ";?><div class="dial">
...
<div class="row">
	...
	<h5>
		...
		if (strcmp($fac_or_rel, "factors") == 0) 
			if (strcmp($worker_role, "annotate") == 0) 
			echo  "<b>Step 2:</b> To pick a term, highlight all the words that describe it by clicking on them. <span class='imgpop'><a href='#' id='factorTypeEx' rel='popover'><img src='img/question.png' width='15' height='15'></a><span>";
		?>
	</h5>
	</div>
...
<div class="row">	
	...
	<h5>
		...
		if (strcmp($fac_or_rel, "factors") == 0) 
			if (strcmp($worker_role, "annotate") == 0) 
			echo  "<b>Step 3:</b> After all the words in the term are highlighted, save the term.";
		?>
	</h5>
	</div>
...
<div class="span3">
	<h5>
		...
		if (strcmp($fac_or_rel, "factors") == 0) 
			if (strcmp($worker_role, "annotate") == 0) 
			echo  "<b>Step 4:</b> After you found all the terms for <span id='ftype'></span>, submit them.";
		?>
	</h5>
</div>
...
Submit your terms for <div class="submitTaskButton"></div></button>
...
<div class="span3">
	<h5>
		...
		if (strcmp($fac_or_rel, "factors") == 0) 
			if (strcmp($worker_role, "annotate") == 0) 
			echo  "<b>Step 5:</b> Go back to step 1 and select another term type, or move on to the next diagnosis.";
		?>
	</h5>
</div>
