      ...
      <div class="navbar-inner">
        <div class="container">
          ...
          <div class="nav-collapse collapse">
            <ul class="nav">
              <li><a href="#" onclick="nextPatient('index')">Home</a></li>
              <li class="active"><a href="#" onclick="nextPatient('game')">Game</a></li>
              <li><a href="#" onclick="nextPatient('leaders')">High Scores</a></li>
            ...
            <ul class="nav pull-right">
              ...
              <li><a href="#" id="notifPopover" rel="popover"><img src="img/red.png" width="25" height="25"><img src="img/blue.png" width="20" height="20"></a></li>
